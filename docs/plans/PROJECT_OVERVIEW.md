...
- **权重**: 成长30% + 价值25% + 质量20% + 动量8% + 实时2% + 风险惩罚10% = 95%
...
| [recommender/RECOMMENDER_ARCHITECTURE.md](./recommender/RECOMMENDER_ARCHITECTURE.md) | 智能推荐模块方案 v18.4 |
...
| [backtester/BACKTESTER_ARCHITECTURE.md](./backtester/BACKTESTER_ARCHITECTURE.md) | 回测验证模块方案 v19.4 |
