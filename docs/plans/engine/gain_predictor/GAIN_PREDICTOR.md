...
| 项目 | 当前值 | 观察方向 | 优化目标 |
|------|--------|----------|----------|
| 趋势加成系数 | ×20 (±4%) | 回测验证趋势信号强度是否合理 | 与RSI/MACD贡献在同一量级 |

> **说明**：当前×20是实现值，暂无充足回测数据证明×10或×15更优。待回测验证后决定是否调整。
...
| 版本 | 日期 | 更新 |
|------|------|------|
| v19.8.1 | 2026-04-14 | 修正趋势加成系数为×20（与实现一致） |
