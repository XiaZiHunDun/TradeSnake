...
| **趋势得分** | MA位置偏离×5，基准点0.95/1.05 | -0.5 ~ +0.5 | 站上MA20为正，跌破MA20为负；基准点不对称设计 |
...
| 项目 | 当前值 | 观察方向 | 优化目标 |
|------|--------|----------|----------|
| 趋势得分基准点 | 0.95/1.05不对称 | 验证不对称惩罚逻辑是否合理 | 更直观的"偏离度×乘数"公式 |

> **说明**：当前基准点设计（跌破MA20比站上MA20惩罚更重）是一种谨慎策略，待回测验证效果后再决定是否调整。
...
| 版本 | 日期 | 更新 |
|------|------|------|
| v19.8.1 | 2026-04-14 | 补充趋势得分公式：基准点0.95/1.05不对称设计 |
| v19.8 | 2026-04-08 | 初版设计文档 |
